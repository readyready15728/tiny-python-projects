...
def get_args():
    ...
    parser = argparse.ArgumentParser(
        description='Heap abuse on user',
...
def main():
    ...
    for _ in range(args.number):
        adjective_sample = ', '.join(random.sample(adjectives, args.adjectives))
        print(f'You {adjective_sample} {random.choice(nouns)}!')
